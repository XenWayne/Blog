...
categories:
  - 技术分享
cover: 'https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/img/picgo/202411011526795.webp'
abbrlink: 7834b51
...
![v0rcxf.png](https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/img/picgo/202411011526795.webp)
## 3.检查启动项，设置等待时间
Win+R运行msconfig，进入"引导"选项卡，你可以看到刚刚修改的启动项出现在引导项中，在此处你可以修改在进入默认OS前给予选择启动项多长的等待时间，当然也可以把NoHyperV的启动项设为默认值，然后重启看效果。
![v0r6RP.png](https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/img/picgo/202411011527861.webp)
![v0ryGt.jpg](https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/img/picgo/202411011527067.webp)
